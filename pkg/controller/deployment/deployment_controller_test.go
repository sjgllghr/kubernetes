...
func (f *fixture) runExpectError(deploymentName string, startInformers bool) {
	f.runHelper(deploymentName, startInformers, true)
}

func (f *fixture) run(deploymentName string) {
	f.runHelper(deploymentName, true, false)
}

func (f *fixture) runHelper(deploymentName string, startInformers bool, expectError bool) {
